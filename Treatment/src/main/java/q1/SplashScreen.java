...
public class SplashScreen  extends JFrame {
		...
		JLabel HospitalName = new JLabel("Hospital");
		MainFrame MainPage ;
		JLabel IconImage ;
		...
		public SplashScreen(String userID) {
			...
			ImageIcon imageIcon = new ImageIcon(CurrentPath+"\\src\\test\\resources\\loading_screen_image.jpg"); // load the image to a imageIcon
			...
			ImageIcon imageIcon2 = new ImageIcon(CurrentPath+"\\src\\test\\resources\\Doctors.png"); // load the image to a imageIcon
			Image image2 = imageIcon2.getImage(); // transform it 
			Image newimg2 = image2.getScaledInstance(600,400,  java.awt.Image.SCALE_SMOOTH); // scale it the smooth way  
			imageIcon2 = new ImageIcon(newimg2);  // transform it back
			DoctorsIcon = new JLabel(imageIcon2);
			DoctorsIcon.setBounds(135,0,600,400);
			...
			HospitalName.setBounds(331,350, 384, 81);
